...
```
 ...
 │   ├─ Sleeper Collector (fantasy-manager-sleeper-nfl-data)   öffentliche Sleeper-Rohdaten (gemeinsame Basis)
...
- [sleeper-nfl-data-collector](./.github/skills/sleeper-nfl-data-collector/SKILL.md) — erfasst alle öffentlich
